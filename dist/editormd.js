...
var toolbarModes = __webpack_require__(10);
var keyMaps = __webpack_require__(6);
var defaults = __webpack_require__(2);
var trim = __webpack_require__(4);
var ucwords = __webpack_require__(5);
var firstUpperCase = __webpack_require__(3);(function (factory) {
  "use strict";
  ...
  editormd.toolbarModes = toolbarModes;
  editormd.defaults = defaults(editormd);

  // Editor.md themes, change toolbar themes etc.
  // added @1.5.0
  editormd.themes = __webpack_require__(9);
  // Preview area themes
  // added @1.5.0
  editormd.previewThemes = __webpack_require__(8);
  // CodeMirror / editor area themes
  // @1.5.0 rename -> editorThemes, old version -> themes
  editormd.editorThemes = __webpack_require__(7);
  ...
  editormd.prototype = editormd.fn = {
    ...
    init: function init(id, options) {
      ...
      id = (typeof id === 'undefined' ? 'undefined' : _typeof(id)) === "object" ? settings.id : id;
    ...
    extend: function extend() {
      ...
      if (_typeof(arguments[0]) === "object" && typeof arguments[0].length === "undefined") {
  ...
  editormd.dateFormat = dateFormat;
...
var keyMaps = (_keyMaps = {}, _defineProperty(_keyMaps, key + "-1", "h1"), _defineProperty(_keyMaps, key + "-2", "h2"), _defineProperty(_keyMaps, key + "-3", "h3"), _defineProperty(_keyMaps, key + "-4", "h4"), _defineProperty(_keyMaps, key + "-5", "h5"), _defineProperty(_keyMaps, key + "-6", "h6"), _defineProperty(_keyMaps, key + "-B", "bold"), _defineProperty(_keyMaps, key + "-D", "datetime"), _defineProperty(_keyMaps, key + "Ctrl-E", function () {
    // emoji
    var cm = this.cm;
    var cursor = cm.getCursor();
    var selection = cm.getSelection();
...
}), _defineProperty(_keyMaps, key + "-Alt-G", "goto-line"), _defineProperty(_keyMaps, key + "-H", "hr"), _defineProperty(_keyMaps, key + "-I", "italic"), _defineProperty(_keyMaps, key + "-K", "code"), _defineProperty(_keyMaps, "Ctrl-L", function CtrlL() {
    var cm = this.cm;
    var cursor = cm.getCursor();
    var selection = cm.getSelection();
...
}), _defineProperty(_keyMaps, key + "-U", "list-ul"), _defineProperty(_keyMaps, "Shift-Ctrl-A", function ShiftCtrlA() {
    var cm = this.cm;
    var cursor = cm.getCursor();
    var selection = cm.getSelection();
...
}), _defineProperty(_keyMaps, "Shift" + key + "-C", "code"), _defineProperty(_keyMaps, "Shift" + key + "Q", "quote"), _defineProperty(_keyMaps, "Shift" + key + "S", "del"), _defineProperty(_keyMaps, "Shift" + key + "K", "tex"), _defineProperty(_keyMaps, "Shift-Alt-C", function ShiftAltC() {
    var cm = this.cm;
    var cursor = cm.getCursor();
    var selection = cm.getSelection();
...
}), _defineProperty(_keyMaps, "Shift-" + key + "-Alt-C", "code-block"), _defineProperty(_keyMaps, "Shift-" + key + "-H", "html-entities"), _defineProperty(_keyMaps, "Shift-Alt-H", "help"), _defineProperty(_keyMaps, "Shift-" + key + "-E", "emoji"), _defineProperty(_keyMaps, "Shift-" + key + "-U", "uppercase"), _defineProperty(_keyMaps, "Shift-Alt-U", "ucwords"), _defineProperty(_keyMaps, "Shift-" + key + "-Alt-U", "ucfirst"), _defineProperty(_keyMaps, "Shift-Alt-L", "lowercase"), _defineProperty(_keyMaps, "Shift-" + key + "-I", function () {
    var cm = this.cm;
    var cursor = cm.getCursor();
    var selection = cm.getSelection();
    var title = selection === "" ? "" : ' "' + selection + '"';
...
}), _defineProperty(_keyMaps, "Shift-" + key + "-Alt-I", "image"), _defineProperty(_keyMaps, "Shift-" + key + "-L", "link"), _defineProperty(_keyMaps, "Shift-" + key + "-O", "list-ol"), _defineProperty(_keyMaps, "Shift-" + key + "-P", "preformatted-text"), _defineProperty(_keyMaps, "Shift-" + key + "-T", "table"), _defineProperty(_keyMaps, "Shift-Alt-P", "pagebreak"), _defineProperty(_keyMaps, "F9", "watch"), _defineProperty(_keyMaps, "F10", "preview"), _defineProperty(_keyMaps, "F11", "fullscreen"), _keyMaps);
...
var editorThemes = ["default", "3024-day", "3024-night", "ambiance", "ambiance-mobile", "base16-dark", "base16-light", "blackboard", "cobalt", "eclipse", "elegant", "erlang-dark", "lesser-dark", "mbo", "mdn-like", "midnight", "monokai", "neat", "neo", "night", "paraiso-dark", "paraiso-light", "pastel-on-dark", "rubyblue", "solarized", "the-matrix", "tomorrow-night-eighties", "twilight", "vibrant-ink", "xq-dark", "xq-light"];

module.exports = editorThemes;
...
// Preview area themes
// added @1.5.0
var previewThemes = ["default", "dark"];

module.exports = previewThemes;
